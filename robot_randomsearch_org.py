...
def setupArena():
    ...
    addObstacle(row=10,col=11)
    addObstacle(row=4,col=16)
    addObstacle(row=4,col=16)
    addObstacle(row=4,col=17)
    addObstacle(row=4,col=18)
    addObstacle(row=4,col=2)
    addObstacle(row=8,col=13)
    addObstacle(row=8,col=12)
    addObstacle(row=8,col=11)
...
maxIterations = 500 # temps passé pour évaluer _un_ robot
nbReevaluations = 4
genomeSize = 10
